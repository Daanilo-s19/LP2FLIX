...
--
-- Host: 127.0.0.1
-- Generation Time: 20-Nov-2018 às 13:02
...
('', 0, 1, 1),
(' O Senhor dos Aneis - O Retor', 31, 1, 1),
('A era do gelo', 1, 1, 1),
('A Viagem de Chihiro', 10, 1, 1),
('A vida secreta dos Pets', 2, 1, 1),
('friends', 20, 5, 22),
('Moana', 3, 3, 113),
('Sherlock', 15, 1, 1);
...
(22, 'FILME', 'ACAO', 'BATMAN - O CAVALEIRO DAS TREVA', 'Christopher Nolan', 'Isaac Bardavid, Christian Bale, Heath Ledger mais', 'images/a22.jpg', 'Após dois anos desde o surgimento do Batman (Christian Bale), os criminosos de Gotham City têm muito o que temer. Com a ajuda do tenente James Gordon (Gary Oldman) e do promotor público Harvey Dent (Aaron Eckhart), Batman luta contra o crime organizado. Acuados com o combate, os chefes do crime aceitam a proposta feita pelo Coringa (Heath Ledger) e o contratam para combater o Homem-Morcego.', '2008', 10, 147, 16, 0, 0),
