...
--
-- Host: 127.0.0.1
-- Generation Time: 21-Nov-2018 às 22:04
...
(28, 'FILME', 'ANIMACAO', 'hÃ¡ perigos no aÃ§ai', ' tiÃ£o sem mÃ£o', '8', '8', '8', '8', 8, 8, 8, 0, 8),
...
('A Bela e a Fera', 5, 15, 623),
('A era do gelo', 0, 10, 464),
('A vida secreta dos Pets', 1, 12, 550),
('ALIEN, O 8Âº PASSAGEIRO', 45, 1, 163),
('ATÃ‰ O ÃšLTIMO HOMEM', 41, 29, 1960),
('BATMAN - O CAVALEIRO DAS TREVA', 21, 1, 147),
('Breaking Bad', 13, 1, 42),
('Como Treinar o seu DragÃ£o 2', 4, 4, 0),
('De Volta para o Futuro', 30, 1, 116),
('Divertida Mente', 7, 3, 95),
('HARRY POTTER E AS RELÃQUIAS D', 34, 1, 129),
('HISTÃ“RIAS CRUZADAS', 41, 29, 1960),
('Logan', 24, 1, 137),
('Moana', 2, 3, 113),
('O AUTO DA COMPADECIDA', 34, 1, 95),
('O Exterminador do Futuro 2 - O', 25, 1, 135),
('O ILUMINADO', 48, 5, 292),
('O LABIRINTO DO FAUNO', 46, 1, 112),
('O PODEROSO CHEFÃƒO', 38, 6, 388),
('O rei LeÃ£o', 3, 3, 89),
('O Senhor dos AnÃ©is - A Socied', 32, 1, 178),
('OperaÃ§Ã£o Big Hero', 18, 1, 102),
('Procurando Nemo', 10, 10, 455),
('procurar', -1, 2, 5),
('PSICOSE', 43, 3, 109),
('SEMPRE AO SEU LADO', 42, 1, 93),
