...
<html lang="en">
    ...
    <body>
        ...
        <div class="header">
            <div class="container">
                <div class="w3layouts_logo">
                    <a href="filmes.php"><h1>BACANA<span>FLIX</span></h1></a>
                </div>
                <div class="w3_search">
        ...
        <div class="Latest-tv-series">
            <h4 class="latest-text w3_latest_text w3_home_popular">Montar carrossel dos generos a parti daqui</h4>
            <div class="container">
...
$('.flexslider').flexslider({
    ...
    start: function (slider) {
        ...
        <!-- Latest-tv-series -->
        <div class="Latest-tv-series">
            <h4 class="latest-text w3_latest_text w3_home_popular">Modular essa merda para cada genero</h4>
            <div class="container">
                <section class="slider">
                    <div class="flexslider">
                        <ul class="slides">
